...
<div class="row mb-3">
    ...
    <div class="col-md-3">
        <div class="card text-bg-warning mb-3">
            <div class="card-body">
                <h5 class="card-title">Paid B2B Sales (Excl. GST)</h5>
                <p class="card-text fs-4">{{ number_format($totalB2BExclgst, 2) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card text-bg-info mb-3">
            <div class="card-body">
                <h5 class="card-title">Paid B2C Sales (Excl. GST)</h5>
                <p class="card-text fs-4">{{ number_format($totalB2CExclgst, 2) }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card text-bg-primary mb-3">
            <div class="card-body">
                <h5 class="card-title">Total Liability (Excl. GST)</h5>
                <p class="card-text fs-4">{{ number_format($TotalLiability, 2) }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card text-bg-warning mb-3">
            <div class="card-body">
                ...
                <p class="card-text fs-4">{{ number_format($monthlyGST, 2) }}</p>
            </div>
        </div>
    </div>
</div>
